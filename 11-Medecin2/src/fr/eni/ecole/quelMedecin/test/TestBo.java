...
public class TestBo {
	...
	private static Adresse sh = new Adresse("ZAC du Moulin Neuf", 2, "B", "rue Benjamin Franklin", 44800,
			"Saint Herblain");
	private static MedecinGeneraliste melanie = new MedecinGeneraliste("Malalaniche", "M√©lanie", "02.28.03.17.28", sh);
	...
	private static void VerifCreneaux() {
		...
		c1.afficher();
		System.out.println("MÈdecin associÈ ‡†ce crÈneau : Dr "+c1.getMedecin().getNom());
		System.out.println("------------------------------------------------------------------");
		melanie.afficher();
	}
	...
	private static void VerifRendezVous() {
		...
		Creneau c1 = new Creneau(LocalTime.of(9, 0), 15, melanie);
		Adresse nio = new Adresse(19, null, "avenue LÈo Lagrange", 79000, "Niort");
		Patient adhemar = new Patient("Pamamobe", "AdhÈmar", "0753428619", 'M', 192112192020142l,
